...
* (TEAMO-7) As a user, I can create an Account so that I can use the App (Est. Pt. : 20, Assigned to: Chengyu Xin)
...
* (TEAMO-8) As a user, I should be able to edit my profile (Est. Pt. : 13, Assigned to: ChengyuXin)
...
* (TEAMO-9) As a user, I can create/join/exit fandoms (Est. Pt. : 13 , Assigned to: Cheng Gao)
  ...
  * back end implementation for join fandoms (Est. Pt. : 2 , Assigned to: Chengyu Xin)
...
* (TEAMO-10) As a user, I should be able to search other fandoms (Est. Pt. : 20 , Assigned to: Hongming Li)
  ...
  * find fandom using MySQL (Est. Pt. : 5 , Assigned to: Hongming Li)
* (TEAMO-39) As a user I can create and edit my post (Est. Pt. : 8 , Assigned to: Xingxin Zheng)
  * front end implementation (Est. Pt. : 2 , Assigned to: Jiasong Liang)
  * using SprtingBoot to handle request (Est. Pt. : 2 , Assigned to: Xingxin Zheng)
  * check if updated information is valid (Est. Pt. : 2 , Assigned to: Xingxin Zheng)
  * check if the user has the right to edit the post (Est. Pt. : 2 , Assigned to: Xingxin Zheng)
